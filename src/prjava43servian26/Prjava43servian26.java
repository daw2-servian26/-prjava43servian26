...
public class Prjava43servian26 extends Frame 
...
public Prjava43servian26 () { 
      ...
      setTitle("nova finestra prjava43servian26");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43servian26();  // Let the construct do the job 
   } 
